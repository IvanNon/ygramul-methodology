...
A working framework for technical SEO and GEO (Generative Engine Optimization) — organized around ten levers, grounded in a primary-source Codex, and designed to learn from each engagement so the rules sharpen with use rather than going stale.
...
- **Ten levers** — eight sequenced engagement levers, one long-arc brand demand lever, and one cross-engagement auto-research lever. Documented in [LEVERS.md](./LEVERS.md).
...
Two levers operate outside the engagement sequence. Lever 9 (Brand & Search Demand Generation) runs in parallel on a multi-year clock. Lever 10 (Auto-Research & Outcome Measurement) operates across the full client base and feeds back to update the rules used in Levers 1–9.
...
This repo is the canonical source for the Ygramul methodology — the philosophy, the ten levers, the relationship between human judgment and AI execution. It does not contain the implementation playbooks, the agent prompts, or the rejection-criteria framework that paying clients receive.
